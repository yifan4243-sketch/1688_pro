...
export default function RuntimeStatusPanel({ runtime, cliInfo, onRefresh, accounts, activeProfile, embedded }: Props) {
  ...
  return (
    <div className={embedded ? 'runtime-status-content' : 'glass-panel-card'}>
      {!embedded && <h2>运行状态</h2>}
