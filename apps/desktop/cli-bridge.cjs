...
const COMMANDS = {
  search: {
    ...
    options: [
      ...
      selectOption('sort', '--sort', '排序', 'relevance', SORT_OPTIONS),
      ...
      boolOption('deeppro', '--deeppro', '深采详情'),
      numberOption('deepproDelayMin', '--deeppro-delay-min', '深采最小等待', 6),
      numberOption('deepproDelayMax', '--deeppro-delay-max', '深采最大等待', 10),
