...
| `OfferBatchResult` | `src/commands/offer.ts` | `mode: 'batch';`<br>`total: number;`<br>`success: number;`<br>`failed: number;`<br>`offerIds: string[];`<br>`offers: OfferResult[];`<br>`failures: OfferFailure[];` |
| `OfferFailure` | `src/commands/offer.ts` | `offerId: string;`<br>`code: string;`<br>`message: string;` |
| `OfferOpts` | `src/commands/offer.ts` | `offerId?: string;`<br>`offerIds?: string[];`<br>`profile?: string;`<br>`headed?: boolean;`<br>`pro?: boolean;` |
...
| `SearchOpts` | `src/commands/search.ts` | `max?: string;`<br>`sort?: string;`<br>`priceMin?: string;`<br>`priceMax?: string;`<br>`province?: string;`<br>`city?: string;`<br>`verified?: string;`<br>`minTurnover?: string;`<br>`excludeAds?: boolean;`<br>`deeppro?: boolean;`<br>`deepproDelayMin?: string;`<br>`deepproDelayMax?: string;`<br>`profile?: string;`<br>`headed?: boolean;` |
| `SearchResult` | `src/commands/search.ts` | `keyword: string;`<br>`sort: SearchSort;`<br>`filters: SearchFilterSummary;`<br>`totalBeforeFilter: number;`<br>`total: number;`<br>`offers: Offer[];`<br>`deeppro?: DeepProSummary;` |
