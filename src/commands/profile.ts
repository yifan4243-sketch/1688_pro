...
import { status as daemonStatus, type DaemonStatus } from '../daemon/manager.js';
...
export interface ProfileSummary {
  ...
  daemon: Pick<DaemonStatus, 'profile' | 'running' | 'pid' | 'reachable' | 'version' | 'expectedVersion' | 'versionMatches'>;
}
